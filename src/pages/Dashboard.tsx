...
const Dashboard: React.FC = () => {
  ...
  const transactions = useSelector((state: RootState) => state.transactions.transactions); // Obtener transacciones del slice
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    if ((formData.type === 'buy' || formData.type === 'sell') && !acciones.some((accion) => accion.name === formData.product)) {
      alert('El producto seleccionado no es válido. Por favor, elige un producto de la lista de acciones.');
      return;
    }
